	...
	<div class="container">
		...
		<div class="card">
			...
			<div class="card-body">
				...
				Order Status : <input type="text" value="${parent.saleOrderStatus}"				
					class="form-control bg-light" readonly="readonly"> <br />					
				<br />
				...
				<form:form action="add" method="POST"
					modelAttribute="saleDtl" cssClass="form-inline">
				...
				<div class="card-footer">
					<table class="table table-hover table-bordered">
						<tr>
							...
							<th>BASE COST</th>
							<th>QTY</th>
							<c:if test="${parent.saleOrderStatus eq 'READY' }">
							<th>OPERATION</th>
							</c:if>
						</tr>
		...
		<td><c:out  value="${ob.qty}"/></td>
					...
					<c:if test="${parent.saleOrderStatus eq 'READY'}">
	<a href="updateStatus?id=${parent.id}&saleOrderStatus=CONFIRM" class="btn btn-success">PLACE ORDER</a>
</c:if>
				</div>
		</div>
